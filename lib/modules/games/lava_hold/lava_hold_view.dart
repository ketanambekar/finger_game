...
import 'lava_hold_game.dart';

class LavaHoldView extends StatelessWidget {
  final box = GetStorage();

  @override
  Widget build(BuildContext context) {
    final game = LavaHoldGame();
            ...
            GameWidget(
              ...
              overlayBuilderMap: {
                'GameOver': (context, _) {
                  ...
                  final best = (box.read('lava_highscore') ?? 0.0).toStringAsFixed(1);
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20),
                        ElevatedButton(
                          onPressed: () => Get.off(() => LavaHoldView()),
                          child: Text("RETRY"),
                        ),
                        SizedBox(height: 10),
                        TextButton(
